### 1. Which of the following is/are enterprise software systems? (Single best Answer)
Select one:
- A. Mobile phone game
...
### 2. The three tiered architecture normally consists of...
Select one:
...
### 3. What is the main advantage of using interfaces in Java?
Select one:
...
### 4. Which of the following is the most significant aspect of enterprise architectures
Select one:
- A. maintainable
- B. reusable
- **C. scalable**
...
### 5. In this unit which component we DO NOT study in detail
Select one or more:
...
### 6. Which of the following is NOT a Java container
Select one:
- **A. Server Container**
- B. Applet container
- C. JVM
...
### 7. What can be contained in a java .jar archive
Select one:
...
### 8. What are the ways to implement persistence in Java
Select one:
...
### 9. What is true about relational databases
Select one:
...
### 10. What's the relationship between Entities in a program and a database
Select one:
...
### 11. Which of the following is always true about application managed entities
Select one:
...
### 12. Which is better to use, persistent fields or persistent properties
Select one:
...
### 13. What is Java Server Faces (JSF)?
Select one:
...
### 14. What do "pass-through-attributes" allow:
Select one:
...
### 15. What are the main differences between JavaScript and Java Server Pages
Select one:
...
### 17. What are some of the scopes for Managed Beans in JSF
Select one:
...
- **E. `@ApplicationScoped, @RequestScoped, @SessionScoped, @ViewScoped` **

### 18. Which of the following provides a binding between the name property of the managed bean user
Select one:
- A. #{empty user.name}
- **B. #{user.name}**
- C. #{user[name]}
...
### 19. What are the two types of requests in JSF?
Select one:
...
### 20. In the JSF lifecycle, for the initial request the stages are
Select one:
...
### 21. In the JSF lifecycle, when validation or conversion of values fails
Select one:
- A. Restore View, Render Response
- B. Restore View, Apply Request Values, Render Response
...
### 22. In the JSF lifecycle, when the values cannot be converted to the type specified in the managed beans
Select one:
- A. Restore View, Render Response
- B. Restore View, Apply Request Values, Render Response
- C. Restore View, Apply Request Values, Process Validations, Render Response
...
### 23. In JEE how are models normally implemented
Select one:
...
### 24. As well as the automatically created JSF FacesServlet Controller, how do we normally create Controllers in JEE
Select one:
- A. JSP Pages
- B. JSF pages
- C. Servlets
...
### 25. Why does data in an Enterprise Application need to be validated
Select one:
...
### 26. When clientside validation is implemented, why does server side validation be repeated?
Select one:
...
### 27. What is needed to implement custom validation in JEE
Select one:
- A. RegexValidator
- B. RequiredValidator
- C. LengthValidator
...
### 28. How is a composition relationship mapped to a relational table in Java ORM
Select one:
...
### 29. How is a key-value store mapped to a relational table in Java ORM
Select one:
...
### 30. How is a bidirectional Many to One relationship mapped to a relational table in Java ORM
Select one:
- A. Using @Embeddable and @Embedded
- B. Using @ManyToOne and @OneToMany
- **C. Using @ManyToOne and @OneToMany with a mappedBy attribute**
...
### 31. What do the persistence Cascade options do
Select one:
...
### 32. Why is Eager loading the default for One to One and Many to One relationships
Select one:
...
### 33. What is the default Inheritance mapping strategy for EJB 3
Select one:
- A. Joined Tables
- B. Table per Class
- **C. Single Table**
...
### 34. Which is more space efficient Joined Tables or Single Table approach to modelling inheritance
Select one:
...
### 35. What are the advantages of the Table per class strategy of inheritance
Select one:
...
### 36. Where do Enterprise Java Beans run
Select one:
...
### 38. What are the benefits of using EJBs
Select one:
...
### 40. What are the different types of EJBS (in EJB 3.0)
Select one:
...
### 41. What are the different types of Session Beans
Select one:
...
### 42!. What are the main features of a stateless session bean (compared to a stateful session bean)
Select one:
...
### - 43!. What are the main features of a stateful session bean (compared to a stateless session bean)
Select one:
...
### 44. What is the main difference between the interface and no-interface implementations of EJBs
Select one:
...
### 46!. The remote interface allows
Select one:
...
### 48. What is/are the lifecycle stages of a Stateless session bean
Select one:
...
### 49. What is/are the lifecycle stages of a Stateful session bean
Select one:
- **A. Non-existant, Ready and Passivated**
- B. @PostConstuct and @PreDestroy
...
### 50. Why is the @PrePassivate annotation needed
Select one:
...
### 51. Why is the @Remove annotation needed
Select one:
...
### 52. What is the problem of having synchronous JEE method calls for long running processes
Select one:
...
### 53. What is the default type of method call in EJBs
Select one:
- A. @Stateful
- B. @Stateless
- C. @Asynchronous
...
### 54. How does a Client receive the results from an Asynchronous method call
Select one:
...
### 55. What sort of operations do enterprises schedule regularly
Select one:
...
### 56. How can ejbs be implemented with a timer service
Select one:
...
### 59. Which of the following would be typical webservice scenarios
Select one:
...
### 60. What is the main difference between SOAP and REST web services
Select one:
...
### 61. What are the advantages of REST webservices
Select one:
...
### 62. What are the possible REST webservice methods
Select one:
- A. GET
...
### 63. A Put method specifies what is submitted using
Select one:
- **A. @Consumes**
- B. @Produces
- C. @GET
...
### 64. The Get parameters are extracted using the annotation
Select one:
...
### 65. A Get method specifies what is returned using
Select one:
- A. @POST
- B. @Consumes
- C. @GET
...
### 66. What is special about data in an enterprise from a security perspective?
Select one:
...
### 67. What are the security problems associated with Internet based Applications?
Select one:
...
### 68. According to OWASP what is the top security risk
Select one:
...
### 69. What types of Web Applications are open to Injection Attacks
Select one:
- A. None of the answers
...
### 70. How does SQL injection attacks work
Select one:
...
### 71. How do we protect against SQL injection attacks
Select one:
- **A. All the answers**
- B. Use criteria API
...
### 72. What is the problem with storing passwords in plain text in the database
Select one:
...
### 73. What's the problem of storing hashed passwords
Select one:
...
### 74. What's the advantage of password salting
Select one:
